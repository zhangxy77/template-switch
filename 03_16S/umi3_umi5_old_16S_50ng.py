...
output1.write("Sample"+"\t"+"Ku_type"+"\t"+"Cycles"+"\t"+"Template"+"\t"+"Biorepeat"+"\t"+"OTO1_umi_num"+"\t"+"OTOMore_umi_num"+"\t"+"Ratio"+"\n")


output2=open(out_path+"%s_minor_pro_3umi_5umi_%s.txt"%(ku_type,umi_reads_filter),"w")
output2.write("Sample"+"\t"+"Ku_type"+"\t"+"Cycles"+"\t"+"Template"+"\t"+"Biorepeat"+"\t"+"Umi3_reads"+"\t"+"Major_geno_reads"+"\t"+"Minor_geno_reads"+"\t"+"Minor_proportion"+"\n")


output3=open(out_path+"Com_repeat_%s_3umi_umi5_types_3umi_%s.txt"%(ku_type,umi_reads_filter),"w")
output3.write("Sample"+"\t"+"Ku_type"+"\t"+"Cycles"+"\t"+"Template"+"\t"+"Umi3"+"\t"+"Geno_type_num"+"\n")

output4=open(out_path+"Com_repeat_%s_3umi_umi5_major_pro_3umi_%s.txt"%(ku_type,umi_reads_filter),"w")
output4.write("Sample"+"\t"+"Ku_type"+"\t"+"Cycles"+"\t"+"Template"+"\t"+"Umi3"+"\t"+"Umi3_reads"+"\t"+"Major_geno_reads"+"\t"+"Minor_geno_reads"+"\t"+"Major_proportion"+"\n")
